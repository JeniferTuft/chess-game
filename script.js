...
document.addEventListener('DOMContentLoaded', () =>{
    let board = null; //Initilize the chessboard
    ...
    let moveCount = 1; //Initilize the move count
    let userColor = 'w'; //Initilize the user's color as white
    ...
    const makeRandomMove = () =>{
        ...
        if(game.game_over()){
            ...
            recordMove(move, moveCount); //Record anad display the move with moveCount
    ...
    //Event listerner for the "Play Again" button
